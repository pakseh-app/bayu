...
(function () {
    ...
    /* =====================================================
       GALLERY MORE — animasi masuk bertahap saat foto terlihat
    ===================================================== */
    function initGalleryMoreAnimation() {
        const items = qsa('.gallery-more-item');
        if (!items.length) return;

        // Fallback sederhana jika IntersectionObserver tidak tersedia.
